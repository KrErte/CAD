 ...
 *
 * <p>Me kasutame ühte {@code static} container'it kogu test-jooksu jooksul
 * (reuse=true). See on ~20x kiirem kui container per test, ja Testcontainers
 * Flyway'ga teeb automaatselt {@code schema cleanup + migrate} iga testi
 * algul, nii et state ei lekki ühest testist teise.
 *
 * <p>Kasutamise näide:
 * <pre>
