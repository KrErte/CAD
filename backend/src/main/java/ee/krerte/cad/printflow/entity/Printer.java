...
public class Printer {
    ...
    public Integer getBuildVolumeXmm() { return buildVolumeXmm; }
    public void setBuildVolumeXmm(Integer v) { this.buildVolumeXmm = v; }
    public Integer getBuildVolumeYmm() { return buildVolumeYmm; }
    public void setBuildVolumeYmm(Integer v) { this.buildVolumeYmm = v; }
    public Integer getBuildVolumeZmm() { return buildVolumeZmm; }
    public void setBuildVolumeZmm(Integer v) { this.buildVolumeZmm = v; }
    public String getSupportedMaterialFamilies() { return supportedMaterialFamilies; }
    public void setSupportedMaterialFamilies(String v) { this.supportedMaterialFamilies = v; }
    public String getAdapterType() { return adapterType; }
    public void setAdapterType(String v) { this.adapterType = v; }
    public String getAdapterUrl() { return adapterUrl; }
    public void setAdapterUrl(String v) { this.adapterUrl = v; }
    public String getAdapterApiKeyEncrypted() { return adapterApiKeyEncrypted; }
    public void setAdapterApiKeyEncrypted(String v) { this.adapterApiKeyEncrypted = v; }
    ...
    public BigDecimal getBedTempC() { return bedTempC; }
    public void setBedTempC(BigDecimal v) { this.bedTempC = v; }
    public BigDecimal getHotendTempC() { return hotendTempC; }
    public void setHotendTempC(BigDecimal v) { this.hotendTempC = v; }
    public Instant getLastHeartbeatAt() { return lastHeartbeatAt; }
    public void setLastHeartbeatAt(Instant v) { this.lastHeartbeatAt = v; }
