...
public class Rfq {
    ...
    public void setQuantityHint(Integer v) { this.quantityHint = v; }
    public String getMaterialHint() { return materialHint; }
    public void setMaterialHint(String v) { this.materialHint = v; }
    public LocalDate getDeadline() { return deadline; }
    public void setDeadline(LocalDate v) { this.deadline = v; }
    public String getAttachments() { return attachments; }
    public void setAttachments(String v) { this.attachments = v; }
    public String getStatus() { return status; }
    public void setStatus(String v) { this.status = v; }
    public Long getAssignedToUserId() { return assignedToUserId; }
    public void setAssignedToUserId(Long v) { this.assignedToUserId = v; }
