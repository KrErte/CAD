...
public interface PrintJobRepository extends JpaRepository<PrintJob, Long> {
    ...
    /**
     * Scheduler algoritm: leia järgmine eelistusega queue-töö konkreetse
     * organisatsiooni ja materjali kohta. Sorteeritud prioriteedi (desc) ja
     * queuing-aja (asc) järgi.
     */
    @Query("""
     ...
     */
    List<PrintJob> findByOrganizationIdAndStatusOrderByPriorityDescQueuedAtAsc(Long orgId, String status);
    ...
    @Query("""
            ...
            """)
    long countActiveSince(@Param("orgId") Long orgId, @Param("statuses") List<String> statuses, @Param("since") Instant since);
}
