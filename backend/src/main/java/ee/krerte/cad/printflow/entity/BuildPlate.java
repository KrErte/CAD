...
public class BuildPlate {
    ...
    public Integer getPlateXmm() {
        return plateXmm;
    }

    public void setPlateXmm(Integer v) {
        this.plateXmm = v;
    }

    public Integer getPlateYmm() {
        return plateYmm;
    }

    public void setPlateYmm(Integer v) {
        this.plateYmm = v;
    }

    public String getNestingData() {
        return nestingData;
    }

    public void setNestingData(String v) {
        this.nestingData = v;
    }
    ...
    public void setPrintedAt(Instant v) {
        this.printedAt = v;
    }
}
