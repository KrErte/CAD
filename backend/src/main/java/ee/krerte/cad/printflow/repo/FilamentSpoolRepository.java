...
public interface FilamentSpoolRepository extends JpaRepository<FilamentSpool, Long> {
    ...
    List<FilamentSpool> findByOrganizationIdAndMaterialIdAndStatusIn(Long orgId, Long materialId, List<String> statuses);
    ...
    @Query("""
            ...
            """)
    List<FilamentSpool> findLowStock(@Param("orgId") Long orgId, @Param("thresholdG") int thresholdG);
}
