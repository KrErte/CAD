...
public class PrintOrder {
    ...
    public int getInfillPct() {
        return infillPct;
    }

    public void setInfillPct(int i) {
        this.infillPct = i;
    }
    ...
    public void setShippingName(String s) {
        this.shippingName = s;
    }
    ...
    public void setShippingCity(String s) {
        this.shippingCity = s;
    }
    ...
    public void setShippingZip(String s) {
        this.shippingZip = s;
    }
    ...
    public void setShippingCountry(String s) {
        this.shippingCountry = s;
    }
    ...
    public void setPriceEur(BigDecimal p) {
        this.priceEur = p;
    }
