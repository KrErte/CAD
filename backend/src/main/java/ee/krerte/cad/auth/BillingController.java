 ...
 *
 * <ul>
 *   <li><b>maker</b> — 12.99 €/kuu või 129 €/a (10.75 €/kuu ekvivalent)
 *   <li><b>pro</b> — 29.99 €/kuu või 299 €/a (24.90 €/kuu ekvivalent)
 *   <li><b>team</b> — 79 €/koht/kuu või 65 €/koht/kuu aastas (alates 3 kohast)
 * </ul>
 *
 * <p>Legacy <b>hobi</b> tier mäpitakse automaatselt <b>maker</b>-le kui keegi veel vana vormil
 * klõpsab. See hoiab vana URL/email kampaaniad töös.
 *
 ...
 * </pre>
 *
 * <p>Kui Stripe pole seadistatud, tagastame 503 sõbraliku teatega — frontend kuvab selle kasutajale
 * (nt "Stripe on seadistamisel, tule peagi tagasi").
 */
@RestController
...
public class BillingController {
    ...
    public BillingController(
            ...
            @Value("${app.stripe.price-maker-monthly:${app.stripe.price-hobi:}}")
                    String priceMakerMonthly,
            @Value("${app.stripe.price-maker-yearly:}") String priceMakerYearly,
            @Value("${app.stripe.price-pro-monthly:${app.stripe.price-pro:}}")
                    String priceProMonthly,
    ...
    public ResponseEntity<?> checkout(@RequestBody CheckoutReq req) {
        ...
        String cycle =
                (req.cycle() == null ? "month" : req.cycle()).toLowerCase(Locale.ROOT).trim();
            ...
            return ResponseEntity.status(503)
                    .body(
                            Map.of(
                                    ...
                                    "price_missing",
                                    "message",
                                    "Hinnakiri seadistamisel (" + tier + "/" + cycle + ")."));
        }
