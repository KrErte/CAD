...
public class DesignsController {
    ...
    public DesignsController(DesignRepository repo) {
        this.repo = repo;
    }
    ...
    public List<Map<String, Object>> list() {
        return repo.findByUserIdOrderByCreatedAtDesc(uid(), PageRequest.of(0, 50)).stream()
                .map(
                        d ->
                                Map.<String, Object>of(
                                        ...
                                        "summary_et",
                                                d.getSummaryEt() == null ? "" : d.getSummaryEt(),
