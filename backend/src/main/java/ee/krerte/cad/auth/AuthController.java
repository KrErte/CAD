...
public class AuthController {
    ...
    public ResponseEntity<?> register(
            @RequestBody RegisterRequest body, HttpServletRequest req, HttpServletResponse resp) {
    ...
    public ResponseEntity<?> login(
            @RequestBody LoginRequest body, HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (user.getPasswordHash() == null) {
            return ResponseEntity.status(401)
                    .body(Map.of("error", "This account uses Google login"));
        }
    ...
    private ResponseEntity<?> issueTokens(
