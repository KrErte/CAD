...
public class SecurityConfig {
    ...
    public SecurityFilterChain chain(
        ...
        http.cors(c -> c.configurationSource(corsConfig()))
                ...
                .oauth2Login(
                        o ->
                                o.userInfoEndpoint(u -> u.userService(oauthUserService))
    ...
    public CorsConfigurationSource corsConfig() {
        ...
        cfg.setAllowedOrigins(
                List.of(frontendUrl, "http://localhost:4200", "https://cad.krerte.ee"));
        cfg.setAllowedMethods(Arrays.asList("GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"));
        cfg.setAllowedHeaders(
                List.of("Authorization", "Content-Type", "X-Idempotency-Key", "X-Request-Id"));
