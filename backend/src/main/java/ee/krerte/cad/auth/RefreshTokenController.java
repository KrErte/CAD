 ...
 *
 * <p><b>Cookie</b>: refresh-token on HttpOnly, Secure, SameSite=Strict cookie'sse.
 * Frontend JS ei puutu seda, XSS ei saa varastada. Backend loeb cookie kaudu.
 *
 * <p><b>POST /api/auth/refresh</b>:
 * <ul>
 *   <li>Loeb cookie'st vana refresh tokeni</li>
 *   <li>Rotate ⇒ uus access JWT (15 min) + uus refresh cookie (30 päeva)</li>
 *   <li>Kui theft detected, ÜKSKI token ei tööta — user peab uuesti login'ima</li>
 * </ul>
 */
@RestController
...
public class RefreshTokenController {
    ...
    public ResponseEntity<?> refresh(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (raw == null) {
            audit.record("TOKEN_REFRESH", "refresh_token", null, "FAILURE",
        ...
        if (result.isEmpty()) {
            ...
            audit.record("TOKEN_REFRESH", "refresh_token", null, "DENIED",
