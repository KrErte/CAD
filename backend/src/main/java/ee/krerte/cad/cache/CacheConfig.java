 ...
 *
 * <ul>
 *   <li>{@code claude:spec} — 7 päeva. Sama prompt + sama catalog = sama spec.
 *       Claude'i vastus on deterministlik temperature=0 puhul, aga me pole
 *       seal temperatuuri 0-ks pannud, nii et kasutame semantic-cache'i
 *       (vt {@code SemanticCacheService}).</li>
 *   <li>{@code claude:review} — 1 päev. Review on rohkem subjective,
 *       nii et me refresh'ime tihemini.</li>
 *   <li>{@code partners:prices} — 15 min. Partner-API hinnad muutuvad
 *       harva, aga me ei taha kuvada päeva-vana infot.</li>
 * </ul>
 *
