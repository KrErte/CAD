 ...
 *
 * <p>Erinevad limit'id plaani järgi (free / maker / pro / team):
 *
 * <ul>
 *   <li>free: 20 spec/h, 10 generate/h
 *   <li>maker: 100 spec/h, 60 generate/h
 *   <li>pro: 300 spec/h, 200 generate/h
 *   <li>team: unlimited (effective) — 10000/h pudelikaitseks
 * </ul>
 *
 * Anonüümsete kasutajate jaoks kasutame IP-põhist rate limit'i (10/h peale mõlema endpoint'i
 * jaoks), et Claude API ei lekiks.
 *
 * <p>Vastavad header'id: - X-RateLimit-Remaining: <n> - X-RateLimit-Limit: <tier limit> -
 * Retry-After: <seconds until next refill> (kui 429)
 *
 * <p>Märkus: in-memory cache — horizontaalne skaleerumine vajab Redis (bucket4j-redis library). See
 * on järgmine samm db-infrastructure branch'is.
 */
@Component
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private final Map<String, TierLimits> tiers =
