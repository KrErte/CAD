    ...
    <section id="why" style="max-width:960px;margin:3rem auto;padding:0 1rem">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:1rem;margin-top:1.5rem">
        ...
        <div class="card">
          ...
          <p style="color:#94a3b8;margin:0">Freemium — proovid ilma kaardita. Pro-pakett 14.99 €/kuu piiramatult.</p>
        </div>
        <div class="card">
          <div style="font-size:1.8rem">🔒</div>
      ...
      <div class="card" style="padding:0;overflow:hidden">
        <table style="width:100%;border-collapse:collapse;color:#e2e8f0">
          ...
          <tbody>
            ...
            <tr style="background:#0f172a"><td style="padding:.6rem .8rem">Hind</td><td style="padding:.6rem .8rem;color:#a7f3d0">Tasuta / 14.99 €/kuu</td><td style="padding:.6rem .8rem">Tasuta</td><td style="padding:.6rem .8rem">5–50 €</td><td style="padding:.6rem .8rem">100–500 €</td></tr>
